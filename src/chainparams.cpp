...
static Checkpoints::MapCheckpoints mapCheckpoints =
        ...
        ( 0, uint256("0x009dda2bb20df665e3c8f0e249196edf70a557818156f5594498949fb19ad58f"))
        ( 1, uint256("0x3c36a150cca1c708003c986f5dc4ae1e65cb1931af8af2d33bf713928451cfc7"))
        ( 2, uint256("0x39a3226626ed8652d4157224d48116ffee630f5f72b789c187de71c625ecd37f"))
        (3, uint256("0x31d37d2066924f66b1a6b3857778c7a10c4f42a505b0d2204789d842f5b2e211"))
        ;
static const Checkpoints::CCheckpointData data = {
        &mapCheckpoints,
        1429635175, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("040184718934759375397593753739aa98742748278429ff90278094828492048902eedaf04fa08dce601aaf0f454216fe1b51ee0b4acf21b179c45070ac7b0acd");
        nDefaultPort = 7744;
        ...
        nMinerThreads = 0;
        nTargetTimespan = 3.5 * 24 * 60; // 3.5 days
         ...
         *   vMerkleTree: 4a5e1e
         */
        const char* pszTimestamp = "NY Times 17/Jun/2015 In Bucharest, an Open Door to Art in a Dictator’s Palace";
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("040184710fa689ad5098593345aa53965536ee90719074ff19043fa84028348226346526674fed8dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b0abc") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1434606159;
        genesis.nBits    = 0x1e0afff0;
        genesis.nNonce   = 4054624588;
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("finclusiontools.com", "testnet-seed.finclusiontools.com"));
        ...
        // Iron: Testnet v2 enforced as of block 400k
...
public:
    CRegTestParams() {
        ...
        // Iron: v2 enforced using Bitcoin's supermajority rule
