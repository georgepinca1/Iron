...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Iron Core iron-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  iron-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded iron transaction") + "\n" +
              "  iron-tx [options] -create [commands]   " + _("Create hex-encoded iron transaction") + "\n" +
              "\n";
