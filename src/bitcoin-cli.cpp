...
std::string HelpMessageCli()
{
    ...
    strUsage += "\n" + _("SSL options: (see the Iron Wiki for SSL setup instructions)") + "\n";
...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        ...
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  iron-cli [options] <command> [params]  " + _("Send command to Iron Core") + "\n" +
                  "  iron-cli [options] help                " + _("List commands") + "\n" +
                  "  iron-cli [options] help <command>      " + _("Get help for a command") + "\n";
